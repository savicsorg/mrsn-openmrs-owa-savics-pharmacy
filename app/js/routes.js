angular.module('routes', []).config(['$stateProvider', '$urlRouterProvider', '$httpProvider', '$locationProvider', function ($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider) {
        ...
        $stateProvider.state('home', {
            ...
            url: 'viewtransaction/:itemuuid:/:uuid',
            template: require('./inventory/Transactionview.html'),
            params: {
                unit: undefined,
                item_id: undefined,
                item_Batch: undefined
            },
    ...
    }]).run(['$rootScope', '$state', '$transitions', 'openmrsTranslate', 'openmrsRest', "$window", function ($rootScope, $state, $transitions, openmrsTranslate, openmrsRest, $window) {
        ...
        $rootScope.selectedLanguage = $window.localStorage.language !== undefined ? $window.localStorage.language.toLowerCase() : navigator.language.substr(0, 2) || navigator.userLanguage.substr(0, 2);
        ;
