...
var searchInJSON = function (json, query, language) {
    var values = [];
    if (query && query != "") {
        _.filter(json, function (obj) {
            var value = ((language != "" && obj[language] != undefined) ? obj[language] : obj['en']);
            var id = obj[id];
            if (value.toLowerCase().match(makePattern(query.toLowerCase()))) {
                values.push({
                    id: id,
                    name: value
                });
...
exports.searchInJSON = searchInJSON;

/**
 * Creates a RegExp that matches the words in the search string.
 * Case and accent insensitive.
 */
var makePattern = function (searchString) {
